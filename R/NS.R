...
north_south_coldiss <- function (dat_thresh_red_path, ab_thresh, arms_id) {
  ...
  north_south_name <- paste0("north_south_", arms_id, "_",ab_thresh, ".pdf")
  north_south_path <- here::here("outputs/beta",  north_south_name)
  ...
  dev.off()
  #### coldiss ####
  heatmap_name <- paste0("heatmap_", arms_id, "_", ab_thresh, ".pdf")
  heatmap_path <- here::here("outputs/beta",  heatmap_name)
